...
Sequential ensemble method that corrects errors of previous models
"""
import pandas as pd
import numpy as np
...
class GradientBoostingModel:
    ...
    def __init__(self, parameters=None):
        ...
        Args:
            parameters: Dict with hyperparameters (n_estimators, learning_rate, max_depth, etc.)
        """
    ...
    def train(self, X, y, epochs=100, validation_split=0.2, nth_candle=None, scaler=None):
        ...
        Args:
            ...
            y: Target vector
            epochs: Number of epochs (for sklearn, this is simulated)
        ...
        self.model = GradientBoostingClassifier(**self.parameters)
        ...
        # Calculate metrics for each epoch (simulated for sklearn)
        metrics = {
            "loss": [],
            "accuracy": [],
            "val_loss": [],
        ...
        for epoch in range(epochs):
            # For sklearn, we train once but simulate epochs
